...
#1、读入txt文本数据  
text = open(r'record.txt',encoding='utf-8').read() 
...
wc = WordCloud(font_path=r"simheittf.ttf",background_color='white',width=800,height=600,max_font_size=50,  
               max_words=1000)#,min_font_size=10)#,mode='RGBA',colormap='pink')  
wc.generate(result)  
wc.to_file(r"wordcloud1.png") #按照设置的像素宽高度保存绘制好的词云图，比下面程序显示更清晰  
